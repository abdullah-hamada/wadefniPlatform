            ...
            <div class="container">
                <div class="row justify-content-center no-gutters vertical-align">
                    <div class="col-lg-4 col-md-6 login-fancy-bg bg"
                        style="background-image: url(assets/images/145.jpg);">
                        <div class="login-fancy">
                            <h2 class="text-white mb-20">أهلا بالموظف المثالي</h2>
                            <p class="mb-20 text-white">طريقك الاسرع للحصول على وظيفة</p>
                        </div>
                    </div>
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="section-field">
                                    <div class="remember-checkbox mb-30">
                                        ...
                                        <a href="{{ route('register') }}" class="float-right">ما عندك حساب؟ انشئ حساب جديد</a>
                                    </div>
                                </div>
